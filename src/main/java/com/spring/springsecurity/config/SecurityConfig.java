...
import com.spring.springsecurity.jwt.JwtFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        log.debug("Configuring SecurityFilterChain in debug");
        log.trace("SecurityFilterChain in trace");
        log.error("SecurityFilterChain in error");
        log.warn("SecurityFilterChain in warn");
        log.info("SecurityFilterChain in info");
         return http
